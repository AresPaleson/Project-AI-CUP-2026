...
def get_features(df):
    ...
    for row in df.itertuples(index=False):
        ...
        # 3. Radar bird size (kept as string here, encoded in main)
...
def main():
    ...
    # --- NEW: Encode the radar_bird_size categorical column ---
    print("Encoding categorical features...")
    le_size = LabelEncoder()
    # Fit on both train and test sets simultaneously to handle all unique values safely
